module.exports = nativeDescription: "English", englishDescription: "English", translation:
  new_home:
    ...
    century_skills_blurb2: "As students progress in the game, they don’t just level up their hero, they level up themselves."
    ...
    century_skills_blurb3: "As students progress in the game, they don’t just level up their hero, they level up themselves."
    century_skills_quote3: "Everyone else was making mazes, so I thought, ‘capture the flag’ and that’s what I did."
    century_skills_subtitle3: "Creativity"
    century_skills_subblurb3: "CodeCombat encourages students to showcase their creativity by building and sharing their own games and webpages."
    century_skills_blurb4: "As students progress in the game, they don’t just level up their hero, they level up themselves."
    ...
    for_leaders_subblurb1: "Promote creativity, problem-solving, and confidence in project-based courses where students develop their own games and webpages."
    for_leaders_subtitle2: "Comprehensive Curriculum"
